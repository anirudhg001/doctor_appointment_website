  ...
  return (
    <div className="p-3 lg:p-5">
        ...
        <div className="mt-2 lg:mt-4 flex items-center justify-between">
            <span className="bg-[#ccf0f3] text-irisBlueColor py-1 px-2 lg:py-2 lg:px-6 text-[12px] leadong-4 
           lg:text-[16px] lg:leading-7 font-semibold rounded">
            {specialization}
            </span>

            <div className="flex items-center gap-[6px]">
                <span className="felx items-center gap-[6px] text-[14px] leading-6 lg:text-[16px]
