          ...
          <div className="flex felx-col lg:felx-row gap-[90px] items-center justify-between">
            ...
            md:leading-[70px]"
                ...
                <p className="text__para">
                  ...
                  Perferendis nisi, rem atque placeat unde dolor esse sequi,
                  nobis beatae iste veritatis? Accusamus natus dolor inventore,
                  consequuntur distinctio magnam temporibus. Et?
                </p>
        ...
        text-center"
         ...
         mt-4 text-center"
                >
                  ...
                  <br /> unmatched, expert health care. From the lab to the
                  Clinic.
                </p>
         ...
         border-[#181A1E] mt-[30px] mx-auto
          flex items-center justify-center group hover:bg-primaryColor
         hover:border-none"
                >
                  <BsArrowRight className="group-hover:text-white w6 h5" />
                </Link>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between flex-col lg:flex-row ">
            ...
            <div className="xl:w-[670px]">
              ...
              <ul className="pt-4">
                ...
                <li className="text__para">
                  3. View our doctors who are accepting new patients, use the
            ...
            {/* ============= feature img =========*/}
            <div
              className="relative z-10 xl:w-[770]
        flex justify-end mt-[50px] lg:mt-0"
            >
              <img src={featureImg} className="w-3/4" alt="" />

              <div className="w-[150px} lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-10 p-2pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
                <div className="flex items-center justify-between">
                 ...
                 text-textColor font-[400]"
                  ...
                  <span
                    className="w-5 h-5 lg:2-[34px] lg:h-[34px] f;ex itmes-center justify-center
              bg-yellowColor rouned py-1 px-[6px] lg:py-3 lg:px-[9px]"
                  >
        ...
        <div className="container">
          <div className="flex justify-between gap-[50px] lg:gap-0">
            ...
            <div className="w-full md:w-1/2">
              <h2 className="heading">
                Most questions asked by beloved patients
              </h2>
              <FaqList />
            </div>
          </div>
