      ...
      <div className="flex felx-col lg:felx-row gap-[90px] items-center justify-between">
        ...
        <div>
          ...
          lg:gap-[30px]">
            ...
            <div>
              <h2 className="text-[36px] leading-[56px] lg:text-[44px] lg:leading-[54px]
              font-[700] text-headingColor">20+</h2>
        ...
        {/*============== Hero Content================ */}
        <div className="felx gap-[30px] justify-end">
          <div>
...
<section>
  <div>
    <div className="lg:w-[470px] mx-auto">
      <h2 className="heading text-center">Providing the best 
      medical services</h2>
        ...
        flex justify-end mt-[50px] lg:mt-0">
          ...
          <div className="w-[150px} lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-10 p-2pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
            <div className="flex items-center justify-between">
              ...
              <span className="w-5 h-5 lg:2-[34px] lg:h-[34px] f;ex itmes-center justify-center
